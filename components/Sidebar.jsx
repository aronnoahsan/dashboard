...
function Sidebar() {
  ...
  function listClassName(path) {
    if (pathName === path) {
      return `${styles.item__flex} ${styles.active__item}`;
    } else {
      return `${styles.item__flex}`;
    }
  }
  return (
    <div className={styles.sidebar__flex}>
      <div className={styles.user__credentials}>
        <Image
        ...
        <ul className={styles.sidebar__list}>
          ...
          <li className={styles.list__item}>
            <Link href="/dashboard/blog">
              <div className={listClassName("/dashboard/blog")}>
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
